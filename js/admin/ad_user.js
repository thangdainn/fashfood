...
function enableEdit() {
    ...
    // userPass.readOnly = false;
        // Do NOT make email and password editable
...
function showSeeInfoModal(email) {
    ...
    userFullName.value = userInfo.userFullName;
    userName.value = userInfo.userName;
    userEmail.value = userInfo.userEmail; // Keep this as readonly
    userPass.value = userInfo.userPass; // Keep this as readonly
    userAddress.value = userInfo.userAddress;
    userPhone.value = userInfo.userPhone;
    userType.value = userInfo.type; // You might want to display this too
    disableEdit(); // Disable all fields, including email and password
}
// Edit info
